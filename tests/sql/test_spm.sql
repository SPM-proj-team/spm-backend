...
(1,'10:13pm 17 Oct --- Learning Journey for GODS',130001,'ur mum gay ur dad lesbian ur granny a tranny ur sister a mister\ndescription testing update of the Learning Journey (2)',1),
(2,'Learning Journey for Dummies (Sales Role) -- ',130001,'lorem ipsum for dummies I HATE SALES',2),(3,'Advanced Learning Journey',140002,'updateds',3);
